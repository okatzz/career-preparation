...
public class HeteroSort {
	...
	public static void main(String[] args) {
        ...
        // put integers and words into two separate lists; keep track of the index/location of integers in the input sequence
        ArrayList<Integer> intIndex = new ArrayList<Integer>(); // the index of integers in the input sequence
